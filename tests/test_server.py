...
class ServerTests(unittest.TestCase):
    ...
    def test_local_ui_and_approval_flow(self):
        ...
        self.assertEqual(health["workspace"]["unsupported_skipped"], 0)
        self.assertFalse(health["workspace"]["truncated"])
        self.assertEqual(health["workspace"]["listing_limit"], 100)
        ...
        self.assertEqual(today["workspace"]["total_bytes"], 0)
        self.assertEqual(today["workspace"]["unsupported_skipped"], 0)
        self.assertFalse(today["workspace"]["truncated"])
        self.assertEqual(today["workspace"]["listing_limit"], 100)
        ...
        self.assertIn("catalog ready", page)
        ...
        self.assertIn("Catalog listing truncated at listing_limit=", page)
        self.assertGreaterEqual(page.count("Catalog listing truncated at listing_limit="), 1)
        ...
        self.assertIn("includes('truncated')", page)
        self.assertEqual(page.count("includes('truncated')"), 1)
        ...
        self.assertGreaterEqual(page.count("total_bytes"), 1)
        ...
        self.assertGreaterEqual(page.count('No work yet.'), 2)
        self.assertIn("folder</small>", page)
        self.assertGreaterEqual(page.count("folder</small>"), 3)
        self.assertIn(' bytes</small>', page)
        self.assertGreaterEqual(page.count(' bytes</small>'), 3)
        ...
        self.assertGreaterEqual(page.count('Workspace is ready and empty.'), 1)
        ...
        self.assertGreaterEqual(page.count('Saved plan'), 1)
        ...
        self.assertEqual(page.count('Searching local names…'), 1)
        ...
        self.assertGreaterEqual(page.count('Diary updated'), 1)
        ...
        self.assertEqual(page.count('The approved local checks finished successfully.'), 1)
        ...
        self.assertIn("documents folder not configured", page)
        self.assertEqual(page.count("documents folder not configured"), 1)
        self.assertEqual(page.count("no cycle recorded yet"), 1)
        ...
        self.assertEqual(page.count("Nothing waiting"), 1)
        ...
        self.assertIn("approved plan${state.in_motion.length === 1 ? '' : 's'}", page)
        ...
        self.assertEqual(page.count("retention on"), 1)
        ...
        self.assertEqual(page.count("quality:'Quality'"), 1)
        ...
        self.assertGreaterEqual(page.count("Supported:"), 2)
