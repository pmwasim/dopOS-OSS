...
class OperationsService:
    ...
    def plan_for_request(self, work_item_id: int) -> dict[str, Any]:
        ...
        if any(phrase in request for phrase in ("runtime health", "service health", "system health", "health probe", "health status", "service probe", "monitor health")):
        ...
        if any(phrase in request for phrase in ("kill switch status", "kill switch", "execution safety", "safety control", "control status", "execution paused", "safety ready")):
