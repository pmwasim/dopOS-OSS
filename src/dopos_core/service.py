...
class OperationsService:
    ...
    def plan_for_request(self, work_item_id: int) -> dict[str, Any]:
        ...
        if any(word in request for word in ("workspace", "document", "documents", "folder", "folders", "file", "files", "file type", "file types", "extension count", "extension counts", "document types", "supported extensions", "allowed document types", "allowed extensions")):
