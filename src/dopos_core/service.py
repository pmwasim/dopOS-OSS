...
class OperationsService:
    ...
    def plan_for_request(self, work_item_id: int) -> dict[str, Any]:
        ...
        if any(phrase in request for phrase in ("runtime health", "service health", "system health", "health probe", "health status", "service probe", "monitor health", "local monitor", "runtime probe", "ledger health", "audit chain", "runtime ledger", "health check", "probe runtime", "local health probe", "local runtime health")):
